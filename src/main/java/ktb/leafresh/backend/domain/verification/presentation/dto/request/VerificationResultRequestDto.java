...
public record VerificationResultRequestDto(
    @NotNull(message = "type은 필수입니다.") ChallengeType type, // PERSONAL 또는 GROUP
    @NotNull(message = "memberId는 필수입니다.") Long memberId,
    @NotNull(message = "challengeId는 필수입니다.") Long challengeId,
    @NotNull(message = "verificationId는 필수입니다.") Long verificationId,
    @NotNull(message = "date는 필수입니다.") String date,
    @NotNull(message = "result는 필수입니다.") String result) {
